...
prescriptionApp.post("/scan", verifyToken(), async (req, res, next) => {
  try {
...
prescriptionApp.get("/", verifyToken(), async (req, res, next) => {
  try {
...
prescriptionApp.post("/", verifyToken(), async (req, res, next) => {
  try {
...
prescriptionApp.get("/:id", verifyToken(), async (req, res, next) => {
  try {
...
prescriptionApp.patch("/:id", verifyToken(), async (req, res, next) => {
  try {
...
prescriptionApp.delete("/:id", verifyToken(), async (req, res, next) => {
  try {
